...
export default function TripComputer({ trip, odometer, fuel, battery }: TripComputerProps) {
  
  // Calculate estimated range based on fuel/battery
    ...
    <View style={styles.container}>
      ...
      <View style={styles.dataGrid}>
        ...
        <View style={styles.dataItem}>
          ...
          <Text style={[styles.dataValue, { color: fuel < 20 ? '#FF4444' : '#00FF88' }]}>
            {fuel.toFixed(0)}%
          </Text>
        ...
        <View style={styles.dataItem}>
          ...
          <Text style={[styles.dataValue, { color: battery < 20 ? '#FF4444' : '#00AAFF' }]}>
            {battery.toFixed(0)}%
          </Text>
        ...
        <View style={styles.levelBar}>
          ...
          <View 
            style={[
              ...
              { 
                width: `${fuel}%`,
                backgroundColor: fuel < 20 ? '#FF4444' : fuel < 50 ? '#FFD700' : '#00FF88'
              }
            ]} 
          />
        </View>
        ...
        <View style={styles.levelBar}>
          ...
          <View 
            style={[
              ...
              { 
                width: `${battery}%`,
                backgroundColor: battery < 20 ? '#FF4444' : battery < 50 ? '#FFD700' : '#00AAFF'
              }
            ]} 
          />
        </View>
