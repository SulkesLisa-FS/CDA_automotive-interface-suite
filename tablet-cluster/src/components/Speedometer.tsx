      ...
      <Svg width={size} height={size}>
        <Defs>
          ...
          <RadialGradient id="needleGradient" cx="30%" cy="30%">
            <Stop offset="0%" stopColor={speed > speedLimit ? "#FF6666" : color} />
            <Stop offset="100%" stopColor={speed > speedLimit ? "#FF0000" : "#008844"} />
          </RadialGradient>
        </Defs>
...
>
      ...
      <View style={styles.digitalDisplay}>
        <Text style={[styles.speedText, { color: speed > speedLimit ? '#FF4444' : color }]}>
          {formatSpeed(speed)}
        </Text>
